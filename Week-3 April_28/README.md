...
Fetches country data from the Rest Countries API https://restcountries.com/v3.1/all, stores it in a MySQL `countries_db` database, and generates a report with the top countries by population, area, and region counts.

## Files
- `Task_5.py` — main script
- `queried_report.csv` — exported report generated by the script

## Output

Run `Task_5.py` to print the query summary to the terminal and generate `queried_report.csv`.


![Task 5 Output](outputs/task_5.png)